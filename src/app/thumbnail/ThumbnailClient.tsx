      ...
      <aside style={{ width: 320, minWidth: 320, background: "#fff", borderRight: "1px solid rgba(0,0,0,0.08)", display: "flex", flexDirection: "column", overflowY: "auto" }}>
        ...
        <div style={{ padding: "20px 16px 16px", flex: 1 }}>
          ...
          <div style={{ marginTop: 10, display: "flex", gap: 5, alignItems: "center" }}>
            <input type="number" placeholder="너비" value={customW} onChange={e => setCustomW(e.target.value)} onKeyDown={e => e.key === "Enter" && addCustomSize()} style={{ width: 60, minWidth: 0, border: "1px solid rgba(0,0,0,0.12)", borderRadius: 7, padding: "5px 7px", fontSize: 11, outline: "none", color: "#1d1d1f" }} />
            <span style={{ fontSize: 11, color: "#aeaeb2" }}>×</span>
            <input type="number" placeholder="높이" value={customH} onChange={e => setCustomH(e.target.value)} onKeyDown={e => e.key === "Enter" && addCustomSize()} style={{ width: 60, minWidth: 0, border: "1px solid rgba(0,0,0,0.12)", borderRadius: 7, padding: "5px 7px", fontSize: 11, outline: "none", color: "#1d1d1f" }} />
